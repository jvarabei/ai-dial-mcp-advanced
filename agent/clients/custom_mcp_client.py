...
class CustomMCPClient:
    ...
    async def _send_request(self, method: str, params: Optional[dict[str, Any]] = None) -> dict[str, Any]:
        ...
        if not self.http_session and method != "initialize":
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            print(f"Connected to MCP server with capabilities: {init_result.get('capabilities', {})}")
    ...
    async def _send_notification(self, method: str) -> None:
        ...
        headers = {
            "Content-Type": "application/json",
            "Accept": "application/json, text/event-stream",
            MCP_SESSION_ID_HEADER: self.session_id
        }
        async with self.http_session.post(self.server_url, json=request_data, headers=headers) as response:
